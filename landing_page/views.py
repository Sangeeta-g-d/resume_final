...
def resume(request, id):
    ...
    print(plain_temp_path)
    name_coordinates = get_coordinates(plain_temp_path, "Name")
    
    # Get coordinates for Phone
    phone_coordinates = get_coordinates(plain_temp_path, "Phone")
    print(name_coordinates)
    print(phone_coordinates)

    context={'plain_temp':plain_temp,'name_coordinates':name_coordinates,'phone_coordinates':phone_coordinates,}
